view: ppp_ppx_pps_go {
  sql_table_name: `VKFE_28Jan2023.PPP_PPX_PPS_GO`
    ;;
  drill_fields: [id]
  ...
  dimension: erc1_estimate_q12020_1 {
    type: number
    sql: ${TABLE}.ERC1EstimateQ12020_1 ;;
  }
  ...
  dimension: erc1_estimate_q22020_1 {
    type: number
    sql: ${TABLE}.ERC1EstimateQ22020_1 ;;
  }
  ...
  dimension: erc1_estimate_q32020_1 {
    type: number
    sql: ${TABLE}.ERC1EstimateQ32020_1 ;;
  }
  ...
  dimension: erc1_estimate_q42020_1 {
    type: number
    sql: ${TABLE}.ERC1EstimateQ42020_1 ;;
  }
  ...
  dimension: vkfe_q1_2021_1 {
    type: number
    sql: ${TABLE}.VKFE_Q1_2021_1 ;;
  }
  ...
  dimension: vkfe_q2_2021_1 {
    type: number
    sql: ${TABLE}.VKFE_Q2_2021_1 ;;
  }
  ...
  dimension: vkfe_q3_2021_1 {
    type: number
    sql: ${TABLE}.VKFE_Q3_2021_1 ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, project_county_name, borrower_name, franchise_name, servicing_lender_name]
  }
}
