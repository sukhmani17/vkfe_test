view: _ppp_ppx_pps_final_29_jan2023_v3_v1_list_email {
  sql_table_name: `VKFE_28Jan2023. PPP_PPX_PPS_final_29Jan2023_v3_v1List_email`
    ;;
  drill_fields: [id]
  ...
  dimension: business_name_v1 {
    type: string
    sql: ${TABLE}.BusinessName_v1 ;;
  }
  ...
  dimension_group: funded_date_v1 {
    type: time
    timeframes: [
      raw,
      date,
  ...
  dimension: ppp_amount_v1 {
    type: number
    sql: ${TABLE}.PPP_Amount_v1 ;;
  }
  ...
  dimension: state_business_v1 {
    type: string
    sql: ${TABLE}.State_Business_v1 ;;
  }
